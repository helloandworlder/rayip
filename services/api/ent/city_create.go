...
func (_c *CityCreate) SetRegionID(v string) *CityCreate {
...
func (_c *CityCreate) SetID(v string) *CityCreate {
	_c.mutation.SetID(v)
	return _c
}
...
func (_c *CityCreate) check() error {
	if _, ok := _c.mutation.RegionID(); !ok {
		return &ValidationError{Name: "region_id", err: errors.New(`ent: missing required field "City.region_id"`)}
	}
...
func (_c *CityCreate) sqlSave(ctx context.Context) (*City, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected City.ID type: %T", _spec.ID.Value)
		}
	}
...
//		}).
//		Exec(ctx)
func (_c *CityCreate) OnConflict(opts ...sql.ConflictOption) *CityUpsertOne {
	_c.conflict = opts
...
//		Exec(ctx)
func (_c *CityCreate) OnConflictColumns(columns ...string) *CityUpsertOne {
...
// SetRegionID sets the "region_id" field.
func (u *CityUpsert) SetRegionID(v string) *CityUpsert {
	u.Set(city.FieldRegionID, v)
	return u
}

// UpdateRegionID sets the "region_id" field to the value that was provided on create.
func (u *CityUpsert) UpdateRegionID() *CityUpsert {
	u.SetExcluded(city.FieldRegionID)
	return u
}
...
// SetRegionID sets the "region_id" field.
func (u *CityUpsertOne) SetRegionID(v string) *CityUpsertOne {
...
// UpdateRegionID sets the "region_id" field to the value that was provided on create.
func (u *CityUpsertOne) UpdateRegionID() *CityUpsertOne {
	return u.Update(func(s *CityUpsert) {
		s.UpdateRegionID()
	})
}
...
func (u *CityUpsertOne) ID(ctx context.Context) (id string, err error) {
...
func (u *CityUpsertOne) IDX(ctx context.Context) string {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
//		}).
//		Exec(ctx)
func (_c *CityCreateBulk) OnConflict(opts ...sql.ConflictOption) *CityUpsertBulk {
	_c.conflict = opts
...
//		OnConflict(sql.ConflictColumns(columns...)).
//		Exec(ctx)
func (_c *CityCreateBulk) OnConflictColumns(columns ...string) *CityUpsertBulk {
	_c.conflict = append(_c.conflict, sql.ConflictColumns(columns...))
	return &CityUpsertBulk{
		create: _c,
	}
...
// SetRegionID sets the "region_id" field.
func (u *CityUpsertBulk) SetRegionID(v string) *CityUpsertBulk {
	return u.Update(func(s *CityUpsert) {
		s.SetRegionID(v)
	})
}
...
// UpdateRegionID sets the "region_id" field to the value that was provided on create.
func (u *CityUpsertBulk) UpdateRegionID() *CityUpsertBulk {
	return u.Update(func(s *CityUpsert) {
		s.UpdateRegionID()
	})
}

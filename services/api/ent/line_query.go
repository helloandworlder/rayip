...
func (_q *LineQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *LineQuery) FirstIDX(ctx context.Context) string {
...
func (_q *LineQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *LineQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *LineQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *LineQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *LineQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(line.Table, line.Columns, sqlgraph.NewFieldSpec(line.FieldID, field.TypeString))
	_spec.From = _q.sql
